...
public class GetMovieVideosApiThread extends AsyncTask<Integer, Object, Object> {
    ...
    public interface MovieVideosResultListener {
        ...
        void updateByMovieVideosResults(List<GetMovieVideosResponse.ResultsBean> moviesList);
